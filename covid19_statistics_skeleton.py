def normalize_data(n_cases, n_people, scale):
    ...
    norm_cases = [x/y *scale for x,y in zip(n_cases, n_people)]
    return norm_cases
...
sum_people = sum(n_people) # TODO: The total number of people CLEAR!
sum_covid  = sum(n_covid) # TODO: The total number of new cases CLEAR!
